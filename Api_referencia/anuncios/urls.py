...
from .views import RideDetailAPIView, RidesAPIView, ManagePassenger, UserRidesListView, UserRidesAPIView
...
urlpatterns = [
    ...
    path('user-rides/<int:user_id>/', UserRidesListView.as_view(), name='user-rides-list'),
     path('rider-caronas/<int:user_id>/', UserRidesAPIView.as_view(), name='user-rides'),
]